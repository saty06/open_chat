...
function ChatContainer() {
  ...
  let themeColor = buttonClicked ? "#125B50" : "#062C30";
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`absolute right-4 top-4 w-12 h-12 rounded-full flex items-center justify-center transition-colors duration-300  '
          }`}
          style={{ fontSize: '20px' }} // Adjust font size for the icon 
        >
           {buttonClicked ? <SunIcon style={{color:"white" }} /> : <Brightness2 style={{color:"whitesmoke"}} />}
      ...
      <div className=" w-full  m-auto flex items-center justify-center flex-col gap-2 my-2">
        ...
        <p className="lg:text-xs text-gray-400 text-center text-[10px]" style={{color:"whitesmoke"}}>
          {/* Free Research Preview. ChatGPT may produce inaccurate information
          about people, places, or facts. ChatGPT August 3 Version */}
          UNICOGPT CAN MAKE MISTAKES. CHECK IMPORTANT INFO.
        </p>
      </div>
